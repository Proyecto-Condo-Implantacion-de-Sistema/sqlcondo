...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 16, 2022 at 11:14 PM
...
CREATE TABLE `apartamento` (
  ...
  `piso` varchar(50) COLLATE utf8mb4_spanish_ci NOT NULL,
  `apartamentos` varchar(50) COLLATE utf8mb4_spanish_ci NOT NULL
...
CREATE TABLE `condominio` (
  `idcondo` int(2) NOT NULL,
  `nombrecondo` varchar(50) CHARACTER SET utf8 COLLATE utf8_spanish_ci NOT NULL,
  `direccioncondo` varchar(50) CHARACTER SET utf8 COLLATE utf8_spanish_ci NOT NULL,
  `RIFcondo` varchar(50) CHARACTER SET utf8 COLLATE utf8_spanish2_ci NOT NULL,
  `numerocondo` varchar(50) COLLATE utf8mb4_spanish_ci NOT NULL,
  `correocondo` varchar(50) CHARACTER SET utf8 COLLATE utf8_spanish_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_spanish_ci;

-- --------------------------------------------------------

--
-- Table structure for table `conjunto residencial`
--

CREATE TABLE `conjunto residencial` (
  `idresidencial` int(11) NOT NULL,
  `nombreresidencial` varchar(50) CHARACTER SET utf8 COLLATE utf8_spanish_ci NOT NULL,
  `rifresidencial` varchar(50) CHARACTER SET utf8 COLLATE utf8_spanish_ci NOT NULL,
  `direccionresidencial` varchar(50) CHARACTER SET utf8 COLLATE utf8_spanish_ci NOT NULL,
...
CREATE TABLE `egresos` (
  `idegreso` int(4) NOT NULL,
  `razonegreso` varchar(50) COLLATE utf8mb4_spanish_ci NOT NULL,
  `mesegreso` date NOT NULL,
  `montoegresodolar` double NOT NULL,
  `montoegresosoberano` double NOT NULL,
  `montoegresototaldolar` double NOT NULL,
  `montoegresototalsoberano` double NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_spanish_ci;
...
CREATE TABLE `factura` (
  ...
  `razon` varchar(30) COLLATE utf8mb4_spanish_ci NOT NULL,
  `mes` date NOT NULL,
  `montodolar` double NOT NULL,
  `montosoberano` double NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_spanish_ci;
...
CREATE TABLE `ingresos` (
  ...
  `razoningreso` varchar(50) COLLATE utf8mb4_spanish_ci NOT NULL,
  `mesingreso` date NOT NULL,
  `montoingresodolar` double NOT NULL,
  `montoingresosoberano` double NOT NULL,
  `ingresototaldolar` double NOT NULL,
  `ingresototalsoberano` double NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_spanish_ci;
...
CREATE TABLE `usuario` (
  ...
  `clave` varchar(5) COLLATE utf8mb4_spanish_ci NOT NULL,
  `status` int(1) NOT NULL,
  `apellido` varchar(50) COLLATE utf8mb4_spanish_ci NOT NULL,
  `cedulausuario` varchar(50) COLLATE utf8mb4_spanish_ci NOT NULL,
  `correo` varchar(50) COLLATE utf8mb4_spanish_ci NOT NULL,
  `numero` varchar(50) COLLATE utf8mb4_spanish_ci NOT NULL,
  `statusinquilino` int(1) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_spanish_ci;
...
ALTER TABLE `condominio`
  ADD PRIMARY KEY (`idcondo`);

--
-- Indexes for table `conjunto residencial`
--
ALTER TABLE `conjunto residencial`
  ADD PRIMARY KEY (`idresidencial`);
...
--
ALTER TABLE `condominio`
  ADD CONSTRAINT `condominio_ibfk_1` FOREIGN KEY (`idcondo`) REFERENCES `apartamento` (`idapartamento`);

--
-- Constraints for table `conjunto residencial`
--
ALTER TABLE `conjunto residencial`
  ADD CONSTRAINT `conjunto residencial_ibfk_1` FOREIGN KEY (`idresidencial`) REFERENCES `condominio` (`idcondo`);

--
-- Constraints for table `egresos`
--
ALTER TABLE `egresos`
  ADD CONSTRAINT `egresos_ibfk_1` FOREIGN KEY (`idegreso`) REFERENCES `factura` (`idfactura`);

--
-- Constraints for table `factura`
--
ALTER TABLE `factura`
  ADD CONSTRAINT `factura_ibfk_1` FOREIGN KEY (`idfactura`) REFERENCES `condominio` (`idcondo`);

--
-- Constraints for table `ingresos`
--
ALTER TABLE `ingresos`
  ADD CONSTRAINT `ingresos_ibfk_1` FOREIGN KEY (`idingreso`) REFERENCES `factura` (`idfactura`);
...
--
ALTER TABLE `usuario`
  ADD CONSTRAINT `usuario_ibfk_1` FOREIGN KEY (`id`) REFERENCES `condominio` (`idcondo`);
COMMIT;
